...
namespace WarframeSharp
{
    ...
    {
        private readonly string BaseUrl = "https://api.warframestat.us";
        private readonly HttpClient HttpClient;

        /// <summary>
        /// Default constructor
        /// </summary>
        public WarframeSharpClient() => this.HttpClient = new HttpClient();
        ...
        public async Task<IEnumerable<Warframe?>> GetWarframeAsync(string query) =>
            await this.GetAsync<IEnumerable<Warframe?>>($"warframes/search/{query.ToLower()}");
        ...
        public async Task<IEnumerable<Warframe>> GetWarframesDataAsync() =>
            await this.GetAsync<IEnumerable<Warframe>>("warframes");
        ...
        public async Task<WorldState?> GetWorldStateDataAsync(PlatformType platform = PlatformType.PC) =>
            await this.GetAsync<WorldState?>($"{platform.ToString().ToLower()}");
        ...
        public async Task<IEnumerable<News>> GetNewsDataAsync(PlatformType platform = PlatformType.PC) =>
            await this.GetAsync<IEnumerable<News>>($"{platform.ToString().ToLower()}/news");
        ...
        public async Task<Nightwave> GetNightwaveStateDataAsync(PlatformType platform = PlatformType.PC) =>
            await this.GetAsync<Nightwave>($"{platform.ToString().ToLower()}/nightwave");
        ...
        public async Task<IEnumerable<Event>> GetEventsDataAsync(PlatformType platform = PlatformType.PC) =>
            await this.GetAsync<IEnumerable<Event>>($"{platform.ToString().ToLower()}/events");
        ...
        public async Task<IEnumerable<Alert>> GetAlertsDataAsync(PlatformType platform = PlatformType.PC) =>
            await this.GetAsync<IEnumerable<Alert>>($"{platform.ToString().ToLower()}/alerts");
        ...
        public async Task<Arbitration> GetArbitrationDataAsync(PlatformType platform = PlatformType.PC) =>
            await this.GetAsync<Arbitration>($"{platform.ToString().ToLower()}/arbitration");
        ...
        public async Task<Sortie?> GetSortieDataAsync(PlatformType platform = PlatformType.PC) =>
            await this.GetAsync<Sortie?>($"{platform.ToString().ToLower()}/sortie");
        ...
        public async Task<IEnumerable<SyndicateMission>>
            ...
            await this.GetAsync<IEnumerable<SyndicateMission>>($"{platform.ToString().ToLower()}/syndicateMissions");
        ...
        public async Task<IEnumerable<Fissure>> GetFissuresDataAsync(PlatformType platform = PlatformType.PC) =>
            await this.GetAsync<IEnumerable<Fissure>>($"{platform.ToString().ToLower()}/fissures");
        ...
        public async Task<IEnumerable<FlashSale>> GetFlashSalesDataAsync(PlatformType platform = PlatformType.PC) =>
            await this.GetAsync<IEnumerable<FlashSale>>($"{platform.ToString().ToLower()}/flashSales");
        ...
        public async Task<IEnumerable<Invasion>> GetInvasionsDataAsync(PlatformType platform = PlatformType.PC) =>
            await this.GetAsync<IEnumerable<Invasion>>($"{platform.ToString().ToLower()}/invasions");
        ...
        public async Task<IEnumerable<DarkSector>> GetDarkSectorsDataAsync(PlatformType platform = PlatformType.PC) =>
            await this.GetAsync<IEnumerable<DarkSector>>($"{platform.ToString().ToLower()}/darkSector");
        ...
        public async Task<VoidTrader?> GetVoidTraderDataAsync(PlatformType platform = PlatformType.PC) =>
            await this.GetAsync<VoidTrader?>($"{platform.ToString().ToLower()}/voidTrader");
        ...
        public async Task<IEnumerable<DailyDeal>> GetDarvoDealsAsync(PlatformType platform = PlatformType.PC) =>
            await this.GetAsync<IEnumerable<DailyDeal>>($"{platform.ToString().ToLower()}/dailyDeals");
        ...
        public async Task<SimarisTarget?> GetSancturayDataAsync(PlatformType platform = PlatformType.PC) =>
            await this.GetAsync<SimarisTarget?>($"{platform.ToString().ToLower()}/simaris");
        ...
        public async Task<IEnumerable<ConclaveChallenge>>
            ...
            await this.GetAsync<IEnumerable<ConclaveChallenge>>($"{platform.ToString().ToLower()}/conclaveChallenges");
        ...
        public async Task<CetusCycle?> GetCetusCycleDataAsync(PlatformType platform = PlatformType.PC) =>
            await this.GetAsync<CetusCycle?>($"{platform.ToString().ToLower()}/cetusCycle");
        ...
        public async Task<EarthCycle?> GetEarthCycleDataAsync(PlatformType platform = PlatformType.PC) =>
            await this.GetAsync<EarthCycle?>($"{platform.ToString().ToLower()}/earthCycle");

        /// <summary>
        /// Conclassion percentages for showing how far conclassed the enemy fleets are.
        /// </summary>
        /// <param name="platform">The platform you would like to get the data for</param>
        /// <returns></returns>
        public async Task<ConclassionProgress?>
            GetConclassionProgressDataAsync(PlatformType platform = PlatformType.PC) =>
            await this.GetAsync<ConclassionProgress>($"{platform.ToString().ToLower()}/conclassionProgress");
        ...
        public async Task<string> GetTimestampAsync(PlatformType platform = PlatformType.PC) =>
            await this.GetAsync<string>($"{platform.ToString().ToLower()}/timestamp");
        ...
        public async Task<IEnumerable<Weapon>> GetWeaponsDataAsync() => 
            await this.GetAsync<IEnumerable<Weapon>>("weapons");
        ...
        public async Task<OrbVallis> GetVallisCycleAsync(PlatformType platform = PlatformType.PC) =>
            await this.GetAsync<OrbVallis>($"{platform.ToString().ToLower()}/vallisCycle");
        ...
        {
            var response = await this.HttpClient.GetAsync($"{this.BaseUrl}/{endpoint}").ConfigureAwait(false);
